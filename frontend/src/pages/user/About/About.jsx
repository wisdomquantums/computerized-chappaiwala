...
const EmployeeCard = ({ member }) => {
  ...
  return (
    <button
      ...
      onClick={toggleFlip}
      className="group relative w-full cursor-pointer rounded-3xl focus:outline-none"
      style={{ perspective: "1200px" }}
    >
      <div
        className={`relative min-h-[540px] rounded-3xl transition-transform duration-500 [transform-style:preserve-3d] ${
          flipped ? "[transform:rotateY(180deg)]" : ""
        } group-hover:[transform:rotateY(180deg)]`}
      >
        <div className="absolute inset-0 flex h-full flex-col rounded-3xl bg-white/95 p-6 text-left shadow-xl ring-1 ring-white/40 backdrop-blur [backface-visibility:hidden]">
          <div
        ...
        <div className="absolute inset-0 flex h-full flex-col justify-between rounded-3xl bg-gradient-to-br from-slate-900 via-slate-900 to-emerald-900 p-6 text-left text-white shadow-xl [backface-visibility:hidden] [transform:rotateY(180deg)]">
  ...
  return (
    <>
      ...
      <main className="bg-slate-950 text-slate-100">
        ...
        <Reveal
          as="section"
          className="grid w-full gap-10 px-4 py-16 sm:px-6 lg:grid-cols-2 lg:px-8"
        >
        ...
        <Reveal as="section" className="w-full px-4 pb-16 sm:px-6 lg:px-8">
          <div className="grid gap-12 rounded-[44px] bg-gradient-to-br from-slate-900 to-slate-800 p-12 shadow-[0_45px_150px_rgba(15,23,42,0.8)] lg:grid-cols-[420px_auto]">
            <div className="mx-auto flex h-80 w-80 items-center justify-center overflow-hidden rounded-[48px] border-[6px] border-emerald-400/50 bg-slate-900">
              <img
                src={
